    ...
    <div className="ticker-container">
      <div className="ticker-content">
        {[...TICKER_DATA, ...TICKER_DATA].map((text, i) => (
          <span key={i} className="mx-12 text-[0.8rem] font-en font-light tracking-widest" style={{ color: 'rgba(212, 175, 55, 0.9)' }}>
            {text}
          </span>
        ))}
      </div>
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center custom-scrollbar ${lang === 'ar' ? 'font-ar' : 'font-sans'}`}>
      ...
      <footer className="w-full py-20 text-center space-y-4 opacity-50 hover:opacity-100 transition-opacity backdrop-blur-xl" style={{ backgroundColor: 'rgba(5, 5, 5, 0.5)', borderTop: '1px solid rgba(255, 255, 255, 0.05)' }}>
        <div className="flex items-center justify-center gap-6 text-xs tracking-widest uppercase mb-8">
        ...
        {/* Golden Glowing Button with Pulse Effect */}
        <div className="flex justify-center mb-8">
          <a 
            href="https://aurametric-fwsi.arcada.app" 
            className="inline-block px-8 py-4 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-bold text-lg rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse hover:animate-none"
            style={{
              boxShadow: '0 0 20px rgba(212, 175, 55, 0.5)',
              animation: 'pulse 2s infinite'
            }}
          >
            Visit AuraMetric App
          </a>
        </div>
        ...
        <div className="space-y-2 mb-8">
          <p className="text-sm text-gray-300">
            لأي استفسار حول الموقع أو خدماتنا، فريق خدمة العملاء هنا للمساعدة.
          </p>
          <p className="text-sm text-gray-300">
            For any inquiries regarding the website or our services, our customer service team is here to help.
          </p>
        </div>
